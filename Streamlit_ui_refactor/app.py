...
def main():
    ...
    if choice=="Predict":
        ...
        p5 = st.number_input("Concavity SE", min_value=0.00, max_value=0.40, value="min")
        p6 = st.number_input("Fractal Dimension SE", min_value=0.00, max_value=0.03, value="min")
        p7 = st.number_input("Smoothness Worst", min_value=0.07, max_value=0.22, value="min")
        p8 = st.number_input("Concavity Worst", min_value=0.00, max_value=1.25, value="min")
        p9 = st.number_input("Symmetry Worst", min_value=0.16, max_value=0.67, value="min")
        p10 = st.number_input("Fractal Dimension Worst", min_value=0.06, max_value=0.21, value="min")
